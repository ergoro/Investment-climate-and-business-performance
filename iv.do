*Instrumental Variables (IV) procedure
quietly{
...
/*
xtset idpanel year
xtivreg tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic = latitude)
outreg2 using myreg3.doc
xtivreg tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic = latitude ethnicfr_latitude religionfr_latitude)
outreg2 using myreg3.doc
xtivreg tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic1 ic2 ic3 = latitude ethnicfr_latitude religionfr_latitude)
outreg2 using myreg3.doc
xtivreg tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic = latitude)
outreg2 using myreg3.doc
xtivreg tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic = latitude ethnicfr_latitude religionfr_latitude)
outreg2 using myreg3.doc
xtivreg tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu i.country2 (ic1 ic2 ic3 = latitude ethnicfr_latitude religionfr_latitude)
outreg2 using myreg3.doc
ivreg2 tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude), robust small first cluster(idpanel) 
outreg2 using myreg3.doc
ivreg2 tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
ivreg2 tfp_stch log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic1 ic2 ic3 = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude), robust small first cluster(idpanel) 
outreg2 using myreg3.doc
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic1 ic2 ic3 = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
xtset, clear
*/
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude), robust small first cluster(idpanel) 
outreg2 using myreg3.doc, replace
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
ivreg2 tfp_acf log_distance_market log_distance_port log_population ln_age eduworker ln_capacityu Bolivia Chile Colombia Ecuador Paraguay Peru Uruguay (ic1 ic2 ic3 = latitude ethnicfr_latitude religionfr_latitude), robust small first  cluster(idpanel)
outreg2 using myreg3.doc
